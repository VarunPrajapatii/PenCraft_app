  ...
  return (
    <div>
      <button
        ...
        aria-label="Sign in"
        className="font-subtitle group relative inline-flex items-center rounded-full cursor-pointer bg-gray-200 dark:bg-gray-700
      ...
      >
        <span className="transition-transform duration-200 group-hover:translate-x-1 group-hover:text-red-700 dark:group-hover:text-red-300">
          Sign In
        </span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="hidden md:inline-block h-5 w-5 ml-2 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-red-700 dark:group-hover:text-red-300"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1.5}
    ...
    <div className='flex items-center gap-4'>
        <Link to="/publish">
          <button
            ...
            className="font-subtitle group relative inline-flex items-center cursor-pointer rounded-full bg-gray-200 dark:bg-gray-700
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" 
              className="md:inline-block size-6 lg:mr-2 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-red-700 dark:group-hover:text-red-300">
              <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
            </svg>
            <span className="hidden lg:block transition-transform duration-200 group-hover:translate-x-1 group-hover:text-red-700 dark:group-hover:text-red-300">
              Pen the Craft
            </span>
          </button>
        </Link>
