const BioEditIcon = () => {
    return (
        <>
            <svg className="w-6 h-6 text-gray-600 dark:text-gray-300 hover:scale-105 cursor-pointer fill-current" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494.936 494.936">
