...
const Footer = () => {
  return (
    <footer className="absolute z-10  w-full h-[35vh] bg-slate-600 backdrop-blur-2xl  shadow-2xl flex flex-col items-center justify-between px-8 py-8 ">
      ...
      <div className="w-full text-center text-gray-400 text-sm font-light">
