                        ...
                        <div className="relative p-4 bg-gradient-to-r from-gray-700 via-gray-500 to-black/30 backdrop-blur-xl border-b border-gray-700/30">
                            ...
                            <div className="relative flex items-center space-x-3">
                                <div className="text-white">
                                    ...
                                    <p className="font-body text-gray-300 text-sm">@{username}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative space-y-1">
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center">
                                        ...
                                        <span className="font-subtitle font-medium text-black group-hover:text-gray-100">{isDarkMode ? 'Light' : 'Dark-Coming'}</span>
                                    </div>
