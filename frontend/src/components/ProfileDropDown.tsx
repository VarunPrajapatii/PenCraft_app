    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <div className={` absolute right-0 mt-3 w-55 origin-top-right transition-all duration-300 z-50 ${isOpen ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 pointer-events-none'}`}>
                ...
                <div className="relative overflow-hidden rounded-3xl shadow-2xl border border-gray-700/30 dark:border-gray-600/50">
                    {/* Dark glass background layers */}
                    <div className="absolute inset-0 bg-gray-500/90 dark:bg-gray-800/90 backdrop-blur-2xl"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-500/60 via-gray-50/80 to-white dark:from-gray-700/60 dark:via-gray-800/80 dark:to-gray-900"></div>


                    <div className="relative">
                        {/* Header Section */}
                        <div className="relative p-4 bg-gradient-to-r from-gray-700 via-gray-500 to-black/30 dark:from-gray-800 dark:via-gray-700 dark:to-gray-900/50 backdrop-blur-xl border-b border-gray-700/30 dark:border-gray-600/40">
                            {/* Header glass overlay */}
                            <div className="relative flex items-center space-x-3">
                                <div className="text-white">
                                    <p className="font-title font-semibold text-lg text-white">{name}</p>
                                    <p className="font-body text-gray-300 dark:text-gray-400 text-sm">@{username}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative p-1  backdrop-blur-sm">
                            ...
                            <div className="relative space-y-1">
                                ...
                                <Link to={`/@${username}`} onClick={() => setIsOpen(false)}>
                                    <button className="w-full flex items-center px-2 py-2 text-black dark:text-white hover:bg-gray-700/50 hover:text-gray-100 hover:backdrop-blur-xl rounded-xl transition-all duration-200 group relative overflow-hidden cursor-pointer">
                                        ...
                                        <span className="relative font-subtitle font-medium">View Profile</span>
                                    </button>
                                </Link>

                                {/* Settings */}
                                <Link to={`/@${username}/editProfile`} onClick={() => setIsOpen(false)}>
                                    <button className="w-full flex items-center px-2 py-2  text-black dark:text-white hover:bg-gray-700/50 hover:text-gray-100 hover:backdrop-blur-2xl rounded-xl transition-all duration-200 group relative overflow-hidden cursor-pointer">
                                        ...
                                        <span className="relative font-subtitle font-medium">Settings</span>
                                    </button>
                                </Link>
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-between px-3 py-2 text-black dark:text-white hover:bg-gray-700/50 hover:text-gray-100 hover:backdrop-blur-2xl rounded-xl transition-all duration-200 group relative overflow-hidden cursor-pointer"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                                    <div className="relative flex items-center">
                                        ...
                                        <span className="font-subtitle font-medium text-black dark:text-white group-hover:text-gray-100">{isDarkMode ? 'Light Mode' : 'Dark Mode'}</span>
                                    </div>
                                ...
                                <button 
                                onClick={signOut}
                                className="w-full flex items-center px-3 py-2 text-red-600 dark:text-red-400 hover:bg-red-600/80 hover:text-red-100 hover:backdrop-blur-2xl rounded-xl rounded-b-2xl transition-all duration-200 group relative overflow-hidden cursor-pointer">
                                    ...
                                    <span className="relative font-subtitle font-medium">Sign Out</span>
                                </button>
                            </div>
                        </div>
                    </div>
